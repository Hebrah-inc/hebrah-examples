    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Register the webhook URL in hebrah, configure hosted MCP credentials, and ensure
          hebrah-mcp-host has your sandbox API key for triggers.
        </p>
      </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              Docker hebrah-api: use <code>host.docker.internal:3002</code> instead of localhost.
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      {envReady && mcpOk && (
        <div className="flex flex-wrap gap-2">
          <Link href="/census" className={buttonVariants()}>
            View census
          </Link>
